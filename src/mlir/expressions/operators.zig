...
pub fn lowerBinary(
    ...
    return switch (bin.operator) {
        ...
        .WrappingSub => self.createArithmeticOp("ora.sub_wrapping", lhs_converted, rhs_converted, result_ty, bin.span),
        .WrappingMul => self.createArithmeticOp("ora.mul_wrapping", lhs_converted, rhs_converted, result_ty, bin.span),
        .WrappingPow => lowerPowerWrappingOp(self, lhs_converted, rhs_converted, result_ty, bin.span),
        .WrappingShl => self.createArithmeticOp("ora.shl_wrapping", lhs_converted, rhs_converted, result_ty, bin.span),
        .WrappingShr => self.createArithmeticOp("ora.shr_wrapping", lhs_converted, rhs_converted, result_ty, bin.span),
