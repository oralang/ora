...
pub const Z3_ast_vector = c.Z3_ast_vector;
pub const Z3_app = c.Z3_app;
pub const Z3_parser_context = c.Z3_parser_context;
pub const Z3_sort = c.Z3_sort;
pub const Z3_symbol = c.Z3_symbol;
pub const Z3_func_decl = c.Z3_func_decl;
pub const Z3_pattern = c.Z3_pattern;
pub const Z3_constructor = c.Z3_constructor;
...
pub const Z3_set_param_value = c.Z3_set_param_value;
...
pub const Z3_mk_solver_for_logic = c.Z3_mk_solver_for_logic;
...
pub const Z3_solver_get_proof = c.Z3_solver_get_proof;
...
pub const Z3_parse_smtlib2_string = c.Z3_parse_smtlib2_string;
pub const Z3_mk_parser_context = c.Z3_mk_parser_context;
pub const Z3_parser_context_inc_ref = c.Z3_parser_context_inc_ref;
pub const Z3_parser_context_dec_ref = c.Z3_parser_context_dec_ref;
pub const Z3_parser_context_from_string = c.Z3_parser_context_from_string;
...
pub const Z3_mk_pattern = c.Z3_mk_pattern;
...
pub const Z3_mk_constructor = c.Z3_mk_constructor;
pub const Z3_mk_datatype = c.Z3_mk_datatype;
pub const Z3_query_constructor = c.Z3_query_constructor;
pub const Z3_del_constructor = c.Z3_del_constructor;
...
pub const Z3_mk_int_sort = c.Z3_mk_int_sort;
...
pub const Z3_func_decl_to_ast = c.Z3_func_decl_to_ast;
pub const Z3_mk_app = c.Z3_mk_app;
pub const Z3_to_app = c.Z3_to_app;
pub const Z3_get_ast_kind = c.Z3_get_ast_kind;
pub const Z3_get_quantifier_num_patterns = c.Z3_get_quantifier_num_patterns;
pub const Z3_get_quantifier_pattern_ast = c.Z3_get_quantifier_pattern_ast;
pub const Z3_get_quantifier_body = c.Z3_get_quantifier_body;
pub const Z3_is_quantifier_forall = c.Z3_is_quantifier_forall;
pub const Z3_get_quantifier_num_bound = c.Z3_get_quantifier_num_bound;
pub const Z3_get_quantifier_bound_name = c.Z3_get_quantifier_bound_name;
pub const Z3_get_quantifier_bound_sort = c.Z3_get_quantifier_bound_sort;
pub const Z3_substitute_vars = c.Z3_substitute_vars;
pub const Z3_get_pattern_num_terms = c.Z3_get_pattern_num_terms;
pub const Z3_get_pattern = c.Z3_get_pattern;
pub const Z3_ast_vector_inc_ref = c.Z3_ast_vector_inc_ref;
pub const Z3_ast_vector_dec_ref = c.Z3_ast_vector_dec_ref;
pub const Z3_ast_vector_size = c.Z3_ast_vector_size;
pub const Z3_ast_vector_get = c.Z3_ast_vector_get;
...
pub const Z3_get_arity = c.Z3_get_arity;
pub const Z3_get_domain = c.Z3_get_domain;
pub const Z3_get_range = c.Z3_get_range;
pub const Z3_sort_to_ast = c.Z3_sort_to_ast;
...
pub const Z3_mk_seq_sort = c.Z3_mk_seq_sort;
pub const Z3_is_seq_sort = c.Z3_is_seq_sort;
pub const Z3_get_seq_sort_basis = c.Z3_get_seq_sort_basis;
pub const Z3_mk_char_sort = c.Z3_mk_char_sort;
pub const Z3_mk_seq_empty = c.Z3_mk_seq_empty;
pub const Z3_mk_seq_unit = c.Z3_mk_seq_unit;
pub const Z3_mk_seq_nth = c.Z3_mk_seq_nth;
...
pub const Z3_mk_lt = c.Z3_mk_lt;
pub const Z3_mk_le = c.Z3_mk_le;
pub const Z3_mk_gt = c.Z3_mk_gt;
pub const Z3_mk_ge = c.Z3_mk_ge;
...
pub const Z3_SEQ_SORT = c.Z3_SEQ_SORT;
pub const Z3_DATATYPE_SORT = c.Z3_DATATYPE_SORT;
pub const Z3_APP_AST = c.Z3_APP_AST;
pub const Z3_QUANTIFIER_AST = c.Z3_QUANTIFIER_AST;
pub const Z3_OP_AND = c.Z3_OP_AND;
pub const Z3_OP_NOT = c.Z3_OP_NOT;
pub const Z3_OP_ITE = c.Z3_OP_ITE;
pub const Z3_OP_SELECT = c.Z3_OP_SELECT;
...
pub const Z3_get_symbol_kind = c.Z3_get_symbol_kind;
pub const Z3_get_symbol_int = c.Z3_get_symbol_int;
pub const Z3_get_symbol_string = c.Z3_get_symbol_string;
pub const Z3_INT_SYMBOL = c.Z3_INT_SYMBOL;
pub const Z3_STRING_SYMBOL = c.Z3_STRING_SYMBOL;
