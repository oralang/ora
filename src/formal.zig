//! Module root for formal snapshot emitters.
//!
//! Files under `src/formal/` are standalone generator entry points. They do not
//! reach upward with `../sema/...` imports, because Zig treats that as outside
//! their module path. This module is rooted at `src/` and exposes only the sema
//! facts those generators need.
