...
pub const entries = [_]Entry{
    ...
    .{ .name = "addWithOverflow", .kind = .add_with_overflow, .signature = "@addWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Add two integers and return both the wrapped result and overflow flag.", .example = "const result = @addWithOverflow(a, b);" },
    ...
    .{ .name = "divWithOverflow", .kind = .div_with_overflow, .signature = "@divWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Divide two integers and return the result plus an overflow flag.", .example = "const result = @divWithOverflow(a, b);" },
    ...
    .{ .name = "modWithOverflow", .kind = .mod_with_overflow, .signature = "@modWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Compute integer remainder and return an overflow flag.", .example = "const result = @modWithOverflow(a, b);" },
    .{ .name = "mulWithOverflow", .kind = .mul_with_overflow, .signature = "@mulWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Multiply two integers and return both the wrapped result and overflow flag.", .example = "const result = @mulWithOverflow(a, b);" },
    .{ .name = "negWithOverflow", .kind = .neg_with_overflow, .signature = "@negWithOverflow(value) -> (value, overflow)", .documentation = "Negate an integer and return both the wrapped result and overflow flag.", .example = "const result = @negWithOverflow(value);" },
    .{ .name = "powerWithOverflow", .kind = .power_with_overflow, .signature = "@powerWithOverflow(base, exp) -> (value, overflow)", .documentation = "Exponentiate integers and return both the wrapped result and overflow flag.", .example = "const result = @powerWithOverflow(base, exp);" },
    ...
    .{ .name = "shlWithOverflow", .kind = .shl_with_overflow, .signature = "@shlWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Shift left and return both the wrapped result and overflow flag.", .example = "const result = @shlWithOverflow(value, bits);" },
    .{ .name = "shrWithOverflow", .kind = .shr_with_overflow, .signature = "@shrWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Shift right and return both the result and overflow flag.", .example = "const result = @shrWithOverflow(value, bits);" },
    ...
    .{ .name = "subWithOverflow", .kind = .sub_with_overflow, .signature = "@subWithOverflow(lhs, rhs) -> (value, overflow)", .documentation = "Subtract two integers and return both the wrapped result and overflow flag.", .example = "const result = @subWithOverflow(a, b);" },
