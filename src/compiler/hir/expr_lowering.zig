    ...
    return struct {
        ...
        pub fn lowerBinary(self: *FunctionLowerer, expr_id: ast.ExprId, binary: ast.BinaryExpr, locals: *LocalEnv) anyerror!mlir.MlirValue {
            ...
            const op = switch (binary.op) {
                ...
                .wrapping_sub => mlir.oraSubWrappingOpCreate(self.parent.context, loc, lhs, rhs, self.parent.lowerExprType(expr_id)),
                .mul => mlir.oraArithMulIOpCreate(self.parent.context, loc, lhs, rhs),
                .wrapping_mul => mlir.oraMulWrappingOpCreate(self.parent.context, loc, lhs, rhs, self.parent.lowerExprType(expr_id)),
                ...
                .wrapping_pow => mlir.oraPowerOpCreate(self.parent.context, loc, lhs, rhs, self.parent.lowerExprType(expr_id)),
                ...
                .wrapping_shl => mlir.oraShlWrappingOpCreate(self.parent.context, loc, lhs, rhs, self.parent.lowerExprType(expr_id)),
                .shr => mlir.oraArithShrSIOpCreate(self.parent.context, loc, lhs, rhs),
                .wrapping_shr => mlir.oraShrWrappingOpCreate(self.parent.context, loc, lhs, rhs, self.parent.lowerExprType(expr_id)),
