export default function (Prism) {
    ...
    Prism.languages.ora = {
        ...
        'type': /\b(?:address|bytes|bytes32|uint256|u256|map|Array|Result|Contract|Event|Function|Tuple|Union|Enum|Struct|Interface|Trait)\b/,
