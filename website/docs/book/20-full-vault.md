...
- **Formal specification** — [`docs/formal-specs/type_system_spec_v1.md`](https://github.com/oralang/Ora/blob/main/docs/formal-specs/type_system_spec_v1.md) for the type system calculus
