...
test "static verifier tautology detection" {
    ...
    var true_literal = ast.LiteralNode{ .Bool = ast.expressions.BoolLiteral{ .value = true, .span = ast.SourceSpan{ .line = 1, .column = 1, .length = 4, .lexeme = "true" } } };
    ...
    try verifier.addCondition(VerificationCondition{
        ...
        .span = ast.SourceSpan{ .line = 1, .column = 1, .length = 4, .lexeme = "true" },
    });
...
test "static verifier false precondition" {
    ...
    var false_literal = ast.LiteralNode{ .Bool = ast.expressions.BoolLiteral{ .value = false, .span = ast.SourceSpan{ .line = 1, .column = 1, .length = 5, .lexeme = "false" } } };
    ...
    try verifier.addCondition(VerificationCondition{
        ...
        .kind = .Precondition,
        .context = VerificationCondition.Context{ .function_name = "test", .old_state = null },
        .span = ast.SourceSpan{ .line = 1, .column = 1, .length = 5, .lexeme = "false" },
    });
