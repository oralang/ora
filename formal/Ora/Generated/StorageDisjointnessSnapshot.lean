...
def storageDisjointnessRows :
  ...
  [("different_roots", ("balances", "storage", [], []), ("allowances", "storage", [], []), true),
   ...
   ("parameter_vs_parameter", ("balances", "storage", [], [("parameter", "0")]), ("balances", "storage", [], [("parameter", "1")]), false),
   ("parameter_vs_constant", ("balances", "storage", [], [("parameter", "0")]), ("balances", "storage", [], [("constant", "2")]), false),
   ...
   ("same_prefix_blocks", ("allowances", "storage", [], [("parameter", "0")]), ("allowances", "storage", [], [("parameter", "0"), ("constant", "1")]), false),
