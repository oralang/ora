...
| Redundant-axiom audit | Core SMT owners + SMT execution solver/tractability owner | Future arc; open | Concrete `ora.map_store` frame quantifier removal in [encoder.zig](/Users/logic/Ora/Ora/src/z3/encoder.zig) is the seed example | [encoder.zig](/Users/logic/Ora/Ora/src/z3/encoder.zig), [encoder.test.zig](/Users/logic/Ora/Ora/src/z3/encoder.test.zig), [verification.zig](/Users/logic/Ora/Ora/src/z3/verification.zig) | Other encoder paths are audited for equivalent "native theory term plus redundant axiom" patterns; redundant axioms are removed or justified with regression tests. |
